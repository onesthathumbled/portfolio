        ...
        <div className="Home">
          ...
          <div className="Details">
            ...
            <p className="HParagraph">
              I'm a seasoned software engineer excelling in innovative
              solutions, programming, and collaborative teamwork. Meticulous and
              deadline-driven, I stay updated on the latest technologies to
              deliver high-impact results aligned with company goals.
            </p>
